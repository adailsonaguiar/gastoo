...
const SwitchContainer = ({isEnabled, toggleSwitch, labelEnable, labelDisable}: SwitchContainerProp) => {
  ...
  return (
    <S.Container>
      ...
      <S.Option onPress={() => toggleButton(0)} isEnabled={buttonActive === false}>
        <S.TitleLabel isEnabled={buttonActive === false}>{labelDisable}</S.TitleLabel>
      </S.Option>
    </S.Container>
  );
};
